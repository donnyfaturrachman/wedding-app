...
<head>
    ...
    <style>
        #forum {
            ...
            border-radius: 20px;
            /* background-image: linear-gradient(to bottom right, #6FD08C, #7B9EA8, #78586F); */
            filter: drop-shadow(0px 0px 10px #2B4950);
        }
        ...
        .message-in:hover,
        .message-out:hover {
            border: 2px solid #3D6972 !important;
        }
    </style>
    <style>
    ...
    <main>
        ...
        <section id="acara">
            ...
            <div class="container h-100">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-12 col-xl-4 mt-2">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body text-center">
                                <div class="col-4 m-auto mt-3 mb-4">
            ...
            <div class="my-5 text-center">
                <a href="https://goo.gl/maps/vfAUuNMzpTdt6SmH7" target="_blank" type="button"
                    class="btn btn-secondary">Lihat Peta</a>
            </div>
        </section>
                ...
                <div class="row align-items-center g-lg-5 py-5">
                    <div class="col-md-10 mx-auto col-lg-8">
                        <form class="p-4 p-md-5 border rounded-3 bg-light">
                            ...
                            <label for="hadir1">Kehadiran</label>
                            <div class="form-floating mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hadir" id="hadir1"
                                        value="1" checked>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="hadir" id="hadir2"
                                        value="0">
                            ...
                            <div id="jumlah_kehadiran">
                                <label for="total_hadir1">Jumlah Kehadiran</label>
                                <div class="form-floating mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="total_hadir"
                                            id="total_hadir1" value="1" checked>
                                        <label class="form-check-label" for="total_hadir1">
                                            1 Orang
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="total_hadir"
                                            id="total_hadir2" value="2">
                                        <label class="form-check-label" for="total_hadir2">
                                            2 Orang
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <small for="hubungan">(cth:Teman Sekolah/Saudara/dll)</small>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="hubungan" name="hubungan"
                                    placeholder="Hubungan Dengan Mempelai">
                                <label for="hubungan">Hubungan Dengan Mempelai</label>
                            </div>
                            <div class="form-floating mb-3">
                                <textarea class="form-control" name="ucapan" id="ucapan" rows="10" placeholder="Ucapan dan Doa"
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-12 col-xl-4">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body text-center">
                                <div class="mt-3 mb-4">
                                    <img src="{{ asset('img/Bank_Central_Asia.svg.webp') }}" class="img-fluid" />
                                </div>
                                <h4 class="mb-2">7391384553</h4>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                /* hadir radio button */
                $('input[type=radio][name=hadir]').change(function() {
                    if (this.value == '1') {
                        $('#jumlah_kehadiran').show();
                    } else if (this.value == '0') {
                        $('#jumlah_kehadiran').hide();
                    }
                });
            });
